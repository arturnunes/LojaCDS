...
Conexao.FecharConexao(con);
    ...
    private void initComponents() {
        ...
        jLabel2.setText("DESATIVAR PROMOÇÃO");
        ...
        jLabel9.setText("OBS : SELECIONE O CD NA TABELA PARA DESATIVAR  A PROMOÇÃO");
...
String codigodocd = String.valueOf(codigo);
 if(codigocd == null){
codigocd = new DesPromocaoCD();
codigocd.setVisible(true);
codigocd.receber(codigodocd);
dispose();
}else{
codigocd.setVisible(true);
codigocd.setState(DesPromocaoCD.NORMAL);
codigocd.receber(codigodocd);
dispose();
}
