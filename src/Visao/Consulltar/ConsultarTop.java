...
public class ConsultarTop extends javax.swing.JFrame {
...
Conexao.FecharConexao(con);
    ...
    private void initComponents() {
        ...
        nome.setText("CD'S MAIS VENDIDOS !");
        ...
        tabela.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Posição", "Titulo", "Disponibilidade", "Preço"
            }
        ));
...
dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConsultarTop.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
